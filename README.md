...
Terraform installed (v1.0 or later is fine)
...
bashgit clone https://github.com/AkmalHakimov/terraform_mini_project.git
...
This folder is one piece of the terraform_mini_project repo, which covers progressively more complex Terraform concepts across multiple directories.
